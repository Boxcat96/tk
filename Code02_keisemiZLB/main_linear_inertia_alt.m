...
hold on
plot([0:Tfig-1],iIRFs((NcRHOr-nadj)*2,1:Tfig)-iIRFs((NcRHOr-nadj)*2-1,1:Tfig),'r','LineWidth',1.5)
title('Effect on the policy rate')
xlabel('Time')
subplot(2,2,1)
plot([0:Tfig-1],niIRFs(2,1:Tfig)-niIRFs(1,1:Tfig),'k','LineWidth',1.5)
hold on
plot([0:Tfig-1],niIRFs((NcRHOr-nadj)*2,1:Tfig)-niIRFs((NcRHOr-nadj)*2-1,1:Tfig),'r','LineWidth',1.5)
title('Effect on the shadow  policy rate')
xlabel('Time')
