...
var y pi i ni rn;
varexo e_rn;
parameters cBETA cSIGMA cKAPPA cALPHA1 cALPHA2 cRELB cRSTAR cPhiPi cRhoR cRhoRN shock_size;
...
//ni = rn + cRhoR*(i(-1)-cRSTAR) + (1.0-cRhoR)*cPhiPi*pi;
ni = cRSTAR + cRhoR*(i(-1)-cRSTAR) + (1.0-cRhoR)*cPhiPi*pi;
i  =  max(ni,cRELB);
